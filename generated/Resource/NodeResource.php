...
class NodeResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\Model\Node[]|\Docker\API\Model\ErrorResponse
     */
     ...
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\Model\ErrorResponse
     */
    public function nodeUpdate($id, \Docker\API\Model\NodeSpec $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();

...
class SecretResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\Model\Secret[]|\Docker\API\Model\ErrorResponse
     */
    ...
    /**
     * @param \Docker\API\Model\SecretsCreateBody $body
     * @param array                               $parameters List of parameters
     * @param string                              $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\Model\SecretsCreateResponse201|\Docker\API\Model\ErrorResponse
     */
    public function secretCreate(\Docker\API\Model\SecretsCreateBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\Model\\SecretsCreateResponse201', 'json');
            }
     ...
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\Model\ErrorResponse
     */
    public function secretUpdate($id, \Docker\API\Model\SecretSpec $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();

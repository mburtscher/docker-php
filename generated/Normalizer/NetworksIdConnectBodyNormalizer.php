...
class NetworksIdConnectBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\NetworksIdConnectBody' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\NetworksIdConnectBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\NetworksIdConnectBody();

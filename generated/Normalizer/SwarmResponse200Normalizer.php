...
class SwarmResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\SwarmResponse200' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\SwarmResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\SwarmResponse200();
        ...
        if (property_exists($data, 'JoinTokens')) {
            $object->setJoinTokens($this->denormalizer->denormalize($data->{'JoinTokens'}, 'Docker\\API\\Model\\SwarmResponse200JoinTokens', 'json', $context));
        }

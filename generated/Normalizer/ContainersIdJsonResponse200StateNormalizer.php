...
class ContainersIdJsonResponse200StateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\ContainersIdJsonResponse200State' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\ContainersIdJsonResponse200State) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\ContainersIdJsonResponse200State();

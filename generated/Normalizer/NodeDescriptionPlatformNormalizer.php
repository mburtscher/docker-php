...
class NodeDescriptionPlatformNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\NodeDescriptionPlatform' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\NodeDescriptionPlatform) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\NodeDescriptionPlatform();

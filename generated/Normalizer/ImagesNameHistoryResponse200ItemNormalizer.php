...
class ImagesNameHistoryResponse200ItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\ImagesNameHistoryResponse200Item' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\ImagesNameHistoryResponse200Item) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\ImagesNameHistoryResponse200Item();

...
class ContainersIdTopResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\ContainersIdTopResponse200' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\ContainersIdTopResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\ContainersIdTopResponse200();

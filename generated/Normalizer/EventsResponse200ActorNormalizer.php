...
class EventsResponse200ActorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\EventsResponse200Actor' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\EventsResponse200Actor) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\EventsResponse200Actor();

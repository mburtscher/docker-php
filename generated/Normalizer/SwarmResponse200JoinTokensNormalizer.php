...
class SwarmResponse200JoinTokensNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\SwarmResponse200JoinTokens' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\SwarmResponse200JoinTokens) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\SwarmResponse200JoinTokens();

...
class TaskSpecResourcesLimitsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\TaskSpecResourcesLimits' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\TaskSpecResourcesLimits) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\TaskSpecResourcesLimits();

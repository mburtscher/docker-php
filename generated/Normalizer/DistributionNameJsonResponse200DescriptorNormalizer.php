...
class DistributionNameJsonResponse200DescriptorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\DistributionNameJsonResponse200Descriptor' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\DistributionNameJsonResponse200Descriptor) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\DistributionNameJsonResponse200Descriptor();

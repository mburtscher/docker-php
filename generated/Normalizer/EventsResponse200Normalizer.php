...
class EventsResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\EventsResponse200' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\EventsResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\EventsResponse200();
        ...
        if (property_exists($data, 'Actor')) {
            $object->setActor($this->denormalizer->denormalize($data->{'Actor'}, 'Docker\\API\\Model\\EventsResponse200Actor', 'json', $context));
        }

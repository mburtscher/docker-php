...
class ContainersIdJsonResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\ContainersIdJsonResponse200' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\ContainersIdJsonResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\ContainersIdJsonResponse200();
        ...
        if (property_exists($data, 'State')) {
            $object->setState($this->denormalizer->denormalize($data->{'State'}, 'Docker\\API\\Model\\ContainersIdJsonResponse200State', 'json', $context));
        }

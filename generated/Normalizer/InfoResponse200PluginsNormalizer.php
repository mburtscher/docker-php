...
class InfoResponse200PluginsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\InfoResponse200Plugins' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\InfoResponse200Plugins) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\InfoResponse200Plugins();

...
class NodeDescriptionEngineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\NodeDescriptionEngine' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\NodeDescriptionEngine) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\NodeDescriptionEngine();
        ...
        if (property_exists($data, 'Plugins')) {
            ...
            foreach ($data->{'Plugins'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\Model\\NodeDescriptionEnginePluginsItem', 'json', $context);
            }

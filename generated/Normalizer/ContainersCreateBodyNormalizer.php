...
class ContainersCreateBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\ContainersCreateBody' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\ContainersCreateBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\ContainersCreateBody();
        ...
        if (property_exists($data, 'NetworkingConfig')) {
            $object->setNetworkingConfig($this->denormalizer->denormalize($data->{'NetworkingConfig'}, 'Docker\\API\\Model\\ContainersCreateBodyNetworkingConfig', 'json', $context));
        }

...
class NetworksIdDisconnectBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\NetworksIdDisconnectBody' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\NetworksIdDisconnectBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\NetworksIdDisconnectBody();

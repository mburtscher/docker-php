...
class SwarmUnlockkeyResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\SwarmUnlockkeyResponse200' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\SwarmUnlockkeyResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\SwarmUnlockkeyResponse200();

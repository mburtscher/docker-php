...
class DistributionNameJsonResponse200PlatformsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\DistributionNameJsonResponse200PlatformsItem' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\DistributionNameJsonResponse200PlatformsItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\DistributionNameJsonResponse200PlatformsItem();

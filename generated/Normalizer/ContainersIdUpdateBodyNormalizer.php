...
class ContainersIdUpdateBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\ContainersIdUpdateBody' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\ContainersIdUpdateBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\ContainersIdUpdateBody();

...
class InfoResponse200RegistryConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\InfoResponse200RegistryConfig' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\InfoResponse200RegistryConfig) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\InfoResponse200RegistryConfig();
        if (property_exists($data, 'IndexConfigs')) {
            $values = new \ArrayObject([], \ArrayObject::ARRAY_AS_PROPS);
            foreach ($data->{'IndexConfigs'} as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Docker\\API\\Model\\InfoResponse200RegistryConfigIndexConfigsItem', 'json', $context);
            }

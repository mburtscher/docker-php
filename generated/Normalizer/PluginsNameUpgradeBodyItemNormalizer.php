...
class PluginsNameUpgradeBodyItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\PluginsNameUpgradeBodyItem' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\PluginsNameUpgradeBodyItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\PluginsNameUpgradeBodyItem();

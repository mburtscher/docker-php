...
class InfoResponse200RegistryConfigIndexConfigsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\Model\\InfoResponse200RegistryConfigIndexConfigsItem' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\Model\InfoResponse200RegistryConfigIndexConfigsItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\InfoResponse200RegistryConfigIndexConfigsItem();
